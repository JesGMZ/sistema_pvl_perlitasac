    ...
    <div class="row">
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                ...
                <h1 class="h3 mb-0">Editar Comité</h1>
            </div>

            <div class="card">
                <div class="card-body p-4">
                    <form action="{{ route('comite.update', $comite) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" 
                                    ...
                                    id="codigo" 
                                    name="codigo" 
                                    value="{{ old('codigo', $comite->codigo) }}"
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" 
                                    ...
                                    id="nombre" 
                                    name="nombre" 
                                    value="{{ old('nombre', $comite->nombre) }}"
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" 
                                    ...
                                    id="coordinadora" 
                                    name="coordinadora" 
                                    value="{{ old('coordinadora', $comite->coordinadora) }}"
                                ...
                                <select class="form-select @error('idmunicipalidad') is-invalid @enderror" 
                                    ...
                                    @foreach($municipalidades as $municipalidad)
                                        <option value="{{ $municipalidad->idmunicipalidad }}" 
                                                {{ old('idmunicipalidad', $comite->idmunicipalidad) == $municipalidad->idmunicipalidad ? 'selected' : '' }}>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('comite.mostrar') }}" class="btn btn-secondary">Cancelar</a>
