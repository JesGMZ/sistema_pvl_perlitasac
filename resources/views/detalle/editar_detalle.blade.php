        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-body p-4">
                    <form action="{{ route('detalle-programa.update', $detalle->iddetallepvl) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select @error('idpvl') is-invalid @enderror" 
                                    ...
                                    @foreach($pvls as $pvl)
                                        <option value="{{ $pvl->idpvl }}" {{ old('idpvl', $detalle->idpvl) == $pvl->idpvl ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select @error('idproductos') is-invalid @enderror" 
                                    ...
                                    @foreach($productos as $producto)
                                        <option value="{{ $producto->idproductos }}" {{ old('idproductos', $detalle->idproductos) == $producto->idproductos ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" 
                                       ...
                                       id="precio" 
                                       name="precio" 
                                       value="{{ old('precio', $detalle->precio) }}"
                                       step="0.01"
                                       min="0"
                                       required>
                                @error('precio')
